...
.flip-card:hover {
  ...
  box-shadow: 0 12px 40px rgba(193, 161, 115, 0.2);
}
...
.flip-card-inner {
  ...
  box-shadow: 0 8px 32px rgba(193, 161, 115, 0.15);
  border-radius: 16px;
...
.view-more {
  ...
  padding-top: 0.8rem;
  margin-top: 0.8rem;
  border-top: 1px solid rgba(193, 161, 115, 0.2);
  width: 100%;
  font-weight: 500;
  color: var(--primary-color);
  display: flex;
...
.flip-card-back:hover .view-more::after {
  opacity: 1;
